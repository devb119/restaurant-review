            ...
            <div className="w-full flex flex-col">
              <label htmlFor="restaurant-img" className="font-bold">
                ...
                <div className="flex gap-4 items-center">
                  <img src={currentRestaurant.image} className="rounded w-[33%]" />
...
function AdminViewDetail({onClose, currentRestaurant} : {onClose : any, currentRestaurant : Restaurant}): JSX.Element {
