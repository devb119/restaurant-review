...
const Admin = () => {
  ...
  const openDetailHandler = (e: Restaurant) => {
    setOpenForm(true);
                  ...
                  <tbody className="text-base">
                    {currentRestaurants?.map((e, index) => (
                      <>
                        <tr
                          key={e.id}
                          className="odd:bg-white even:bg-slate-200 border-none  border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                        >
                          <th
                            scope="row"
                          ...
                          <td className="px-6 py-4">{e.managerFullName}</td>
                          <td className="px-6 py-4">
                            {/* {e.created_at ? e.created_at?.toLocaleString() : ""} */}
                            {e.custom_created_at
                              ? e.custom_created_at.toLocaleString()
                              : ""}
                          </td>
                          <td className="px-6 py-4 text-right">
                            <StatusUpdate
                              restaurant={e}
                              openDetail={() => openDetailHandler(e)}
                            />
                          </td>
                        </tr>
                      </>
