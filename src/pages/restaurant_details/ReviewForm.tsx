...
const ReviewForm = ({ setOpenModal, restaurant_id, id }: Props) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-slate-800 bg-opacity-50 flex justify-center items-center ">
      <div className="bg-white flex flex-col p-6 relative items-center justify-between w-1/2 p-10h-2/3 min-h-685 mx-auto shadow-xl rounded-xl px-32">
