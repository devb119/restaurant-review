...
const  AppealFood = memo(({ foodLists }: { foodLists: Food[] }) => {
    ...
    <div>
      <div className=" mt-8">
        ...
        <div className="flex items-center">
          ...
          <AppealFoodCard loading={loading} currentDisplay={currentDisplay}></AppealFoodCard>
          <span
            className={
              hasNext
                ? "text-2xl text-main font-semibold cursor-pointer"
...
const AppealFoodCard= ({ loading, currentDisplay }: { loading: boolean; currentDisplay: Food[] })=> {
